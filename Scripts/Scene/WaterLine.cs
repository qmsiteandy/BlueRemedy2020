...
public class WaterLine : MonoBehaviour
{
    ...
    private void Initialize()
    {
        ...
        for (int i = 0; i < size; i++)
        {
            ...
            go.transform.localPosition = new Vector3((i - (size / 2))*widthPerMesh, 0, 0);
        ...
        for (int i = 0; i < size; i++)
        {
            ...
            if (i < size - 1)
            {
                ...
                meshRenderer.sortingLayerName = "Scene";
    ...
    void Update()
    {
        ...
        if (Mathf.Ceil(Width) != Mathf.Ceil(size * widthPerMesh) || Height != currentHeight)
        {
